...
Quantitative research and machine learning candidate trained in data-intensive science and theoretical physics. Focused on market-neutral hedging, high-frequency futures and equity data, feature engineering, time-series prediction, market microstructure, backtesting, and model validation.
...
- **Programming:** Python, SQL, C++, MATLAB, Linux, Git, Docker, Pytest, Jupyter, Conda, UV.
- **Data & ML:** NumPy, SciPy, SymPy, Matplotlib, Pandas, Polars, PyTorch, TensorFlow, Scikit-learn.
- **Quant Research:** Factor research, market microstructure, high-frequency data, backtesting, purged cross-validation, portfolio construction.
- **Optimisation:** ONNX, Numba, JIT, Cython, multiprocessing, multithreading, PyTorch Distributed Data Parallel.
...
**Xuanye Investment**, Quantitative Analyst Intern, Remote, *Nov 2024 - Mar 2025*
- Assisted with multi-factor strategy research on A-share daily price-volume and fundamental data.
- Used Pandas for data cleaning, PCA for dimensionality reduction, and random-forest models to capture nonlinear relationships beyond a linear Barra-style baseline.

## Selected Research Projects

**A-share High-Frequency Deep Learning Framework**, Independent research framework, *Jun 2026 - Present*
- Designed a research framework for A-share high-frequency prediction, combining feature engineering with multi-scale sequence modelling.
- Built Mamba-3 state-space, causal GRU, and Transformer cross-attention architectures with single-GPU and multi-GPU training, inference, logging, and model comparison.

**WunderFund Limit Order Book Prediction Competition**, Market microstructure modelling, *Jan 2026 - Mar 2026*
- Built predictive models from anonymised limit-order-book sequences over multiple future horizons.
...
- **IMC Prosperity 4 Trading Challenge**, 2026: ranked #327 / 22,130 globally, top 1.4%.
